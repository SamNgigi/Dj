...
from .models import ApiTest, LANGUAGE_CHOICES, STYLE_CHOICES, Item
...
class ApiTestSerializer(ModelSerializer):
    class Meta:
        model = ApiTest
        fields = '__all__'
    ...
    def update(self, instance, validated_data):
        ...
        class ApiTestSerializer(serializers.Serializer):
            ...
            def update(self, instance, validated_data):
                ...
                Update and return an existing ApiTest instance given
                the validated data
